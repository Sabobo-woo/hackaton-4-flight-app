...
export default function SearchBar({ setApiUrl, setIsDirect, searchInput, setSearchInput }) {
  ...
  const handleSearch = () => {
    setApiUrl(`https://api.skypicker.com/flights?fly_from=${searchInput.flyFrom}&fly_to=${searchInput.flyTo}&date_from=${searchInput.dateFrom}&date_to=${searchInput.dateTo}&partner=data4youcbp202106`)
  }
